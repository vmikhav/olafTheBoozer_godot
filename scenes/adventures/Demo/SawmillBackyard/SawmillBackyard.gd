...
var first_dialogue = preload("res://scenes/adventures/Demo/SawmillBackyard/sawmill.dialogue")
...
func _ready():
	...
	if StoryProgress.sawmill_intro:
		...
		hero.set_orientation("right")
		next_scene = ["res://scenes/game/AdventurePlayground/AdventurePlayground.tscn", {levels = ["Demo/RepairedSawmillBackyard"]}]
		outro()
	else:
		next_scene = ["res://scenes/game/Playground/Playground.tscn", {levels = ["Demo/SawmillWarehouse"]}]
		intro()
