...
func _ready():
	...
	if !StoryProgress.cellar_fixed:
		intro()
		next_scene = ["res://scenes/game/Playground/Playground.tscn", {levels = ["Demo/TutorialBarrel", "Demo/Cellar"]}]
	elif !StoryProgress.warehouse_fixed:
		warehouse_quest()
		next_scene = ["res://scenes/game/Playground/Playground.tscn", {levels = ["Demo/TavernWarehouse"]}]
